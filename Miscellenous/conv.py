...
class CONV:
	...
	def FirstSpeech():	
		tool.reply("Jarvis is now Online.. Good {0} sir,".format(day), "Jarvis now hat your service sir", "I'm now active")
	def hibernate():
		tool.reply("Hibernating...", "Jarvis is now going inactive...", "Hibernating... If you need me again, just say the words, Jarvis wake up. and I will become active again to attend to your needs. Thank you", "I am now going inactive, you can summon me again by saying the words, Jarvis wake up, Bye for now")
	def conv(text):
		...
		if text[0:5] == "hello" or text == "you know" or text == "i mean" or text=="the law" or text=="a lot" or "a no" in text or text=="and know" or (text[0:8] == "and know" and ("jarvis" in text or "jones" in text or "job" in text or "germ" in text or "joe" in text or "jer" in text)) or text[0:6]=="and no" or (text[0:6] == "and no" and ("jarvis" in text or "jones" in text or "job" in text or "germ" in text or "joe" in text or "jer" in text)) or text[0:5]=="oh no" or (text[0:6] == "oh no" and ("jarvis" in text or "jones" in text or "job" in text or "germ" in text or "joe" in text or "jer" in text)) or (text[0:6] == "a move" and ("jarvis" in text or "jones" in text or "job" in text or "germ" in text or "joe" in text or "jer" in text)) or text == "a move" or text[0:5] =="a low" or (text[0:5] == "a low" and ("jarvis" in text or "jones" in text or "job" in text or "germ" in text or "joe" in text or "jer" in text)) or text == "a new" or (text[0:5] == "a new" and ("jarvis" in text or "jones" in text or "job" in text or "germ" in text or "joe" in text or "jer" in text)):	
		...
		elif text == "jarvis" or text=="japanese" or "journalist" in text or text == "johnny's" or text=="judges"  or text == "job" or text=="jones" or text== "germany's":
			
			tool.reply("Yes sir", "I'm all hears sir","I'm with you","what can I do for you sir")
			...
			tool.reply("you are welcome sir", "anytime", "my pleasure")
			...
			tool.reply("It was great, thank you sir", "Fine sir")
			...
			tool.reply("I'm still with you sir","Yes sir","at your service sir", "As always, what do you need me to do")
		elif "sleep" in text:	
		...
		elif ("who are" in text and "you" in text) or ("tell" in text and "about you" in text) or ("tell" in text and "you" in text and "who" in text) or ("what" in text and "can you" in text and "do" in text):	
			tool.reply("I am Jarvis, an advance ARTIFICIAL INTELLIGENT MACHINE created by DaraTronics to render you services")
		elif "funny" in text:
		...
		elif ("what" in text) and ("ate" in text and "to" in text or "day" in text or (text[-3:] == "did" and "to" in text)) :
		...
		elif (("what is" in text or "what's" in text) or ("who is" in text or "who's" in text) or ("what" in text and (text[-5:] == "means" or text[-4:] == "mean"))):
